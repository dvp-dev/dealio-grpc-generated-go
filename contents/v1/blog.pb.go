...
const (
	...
	BlogGetListRequest_POPULAR            BlogGetListRequest_SortBy = 4
)
...
func (x *BlogGetListRequest) GetSearch() string {
	if x != nil {
		return x.Search
	}
	return ""
...
func (x *BlogGetListRequest) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type BlogGetListResponseStream struct {
	...
	IsLovelist    bool  `protobuf:"varint,4,opt,name=is_lovelist,json=isLovelist,proto3" json:"is_lovelist,omitempty"`
	CountLovelist int32 `protobuf:"varint,5,opt,name=count_lovelist,json=countLovelist,proto3" json:"count_lovelist,omitempty"`
}
...
func (x *BlogGetListResponseStream) GetCount() int32 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *BlogGetListResponseStream) GetMaxPage() int32 {
	if x != nil {
		return x.MaxPage
	}
	return 0
...
func (x *BlogGetListResponseStream) GetIsLovelist() bool {
	if x != nil {
		return x.IsLovelist
	}
	return false
...
func (x *BlogGetListResponseStream) GetCountLovelist() int32 {
	if x != nil {
		return x.CountLovelist
	}
	return 0
}
...
func (x *BlogGetOneRequest) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type BlogGetOneResponse struct {
	...
	Data          *Blog `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	IsLovelist    bool  `protobuf:"varint,2,opt,name=is_lovelist,json=isLovelist,proto3" json:"is_lovelist,omitempty"`
	CountLovelist int32 `protobuf:"varint,3,opt,name=count_lovelist,json=countLovelist,proto3" json:"count_lovelist,omitempty"`
}
...
func (x *BlogGetOneResponse) GetIsLovelist() bool {
	if x != nil {
		return x.IsLovelist
	}
	return false
...
func (x *BlogGetOneResponse) GetCountLovelist() int32 {
	if x != nil {
		return x.CountLovelist
	}
	return 0
...
type BlogSetLovelistRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BlogId     int32 `protobuf:"varint,1,opt,name=blog_id,json=blogId,proto3" json:"blog_id,omitempty"`
	UserId     int32 `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	IsLovelist bool  `protobuf:"varint,3,opt,name=is_lovelist,json=isLovelist,proto3" json:"is_lovelist,omitempty"`
}

func (x *BlogSetLovelistRequest) Reset() {
	*x = BlogSetLovelistRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_contents_v1_blog_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *BlogSetLovelistRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlogSetLovelistRequest) ProtoMessage() {}

func (x *BlogSetLovelistRequest) ProtoReflect() protoreflect.Message {
	mi := &file_contents_v1_blog_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlogSetLovelistRequest.ProtoReflect.Descriptor instead.
func (*BlogSetLovelistRequest) Descriptor() ([]byte, []int) {
	return file_contents_v1_blog_proto_rawDescGZIP(), []int{5}
}

func (x *BlogSetLovelistRequest) GetBlogId() int32 {
	if x != nil {
		return x.BlogId
	}
	return 0
...
func (x *BlogSetLovelistRequest) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *BlogSetLovelistRequest) GetIsLovelist() bool {
	if x != nil {
		return x.IsLovelist
	}
	return false
...
type BlogSetLovelistResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *BlogSetLovelistResponse) Reset() {
	*x = BlogSetLovelistResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_contents_v1_blog_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *BlogSetLovelistResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlogSetLovelistResponse) ProtoMessage() {}

func (x *BlogSetLovelistResponse) ProtoReflect() protoreflect.Message {
	mi := &file_contents_v1_blog_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlogSetLovelistResponse.ProtoReflect.Descriptor instead.
func (*BlogSetLovelistResponse) Descriptor() ([]byte, []int) {
	return file_contents_v1_blog_proto_rawDescGZIP(), []int{6}
}
...
var file_contents_v1_blog_proto_rawDesc = []byte{
	...
	0x70, 0x52, 0x08, 0x64, 0x61, 0x74, 0x65, 0x74, 0x69, 0x6d, 0x65, 0x22, 0xe5, 0x02, 0x0a, 0x12,
	...
	,
	...
	,
...
var file_contents_v1_blog_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_contents_v1_blog_proto_goTypes = []interface{}{
	...
	(*BlogSetLovelistResponse)(nil),   // 7: contents.v1.BlogSetLovelistResponse
	(*timestamppb.Timestamp)(nil),     // 8: google.protobuf.Timestamp
}
var file_contents_v1_blog_proto_depIdxs = []int32{
	8, // 0: contents.v1.Blog.datetime:type_name -> google.protobuf.Timestamp
...
func file_contents_v1_blog_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_contents_v1_blog_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BlogSetLovelistRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_contents_v1_blog_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BlogSetLovelistResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
